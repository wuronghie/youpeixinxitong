...
module.exports = {
	...
	"notifyUrl": {
		// 测试环境服务空间-支付回调地址
		"mp-feefb659-358b-4c0f-938b-e3764472432b": "https://fc-mp-feefb659-358b-4c0f-938b-e3764472432b.next.bspapp.com/uni-pay-co",
		// 线上环境服务空间-支付回调地址（如果只有一个服务空间，则只需要配置线上环境服务空间即可）
		"mp-feefb659-358b-4c0f-938b-e3764472432b": "https://fc-mp-feefb659-358b-4c0f-938b-e3764472432b.next.bspapp.com/uni-pay-co",
	},
	"notifyKey": "5FB8417C5072CD73C267B5391872E6D4", // 跨云函数通信时的加密密钥，建议手动改下，不要使用默认的密钥，长度保持在32位即可
	// 微信支付相关
	"wxpay": {
		"enable": true, // 是否启用微信支付
		// 微信 - 小程序支付
		"mp": {
			"appId": "wx920e8bcaa338caf6", // 小程序的appid
			"secret": "cec27ee7aba7f54b6a56ae1659d1bd77", // 小程序的secret
			"mchId": "1738033382", // 商户id
			"key": "", // v2的api key
			"pfx": fs.readFileSync(__dirname + '/wxpay/apiclient_cert.p12'), // v2需要用到的证书
			"v3Key": "CAACRpk28D2SEvM5aMFAFyrjhjFKZUUQ", // v3的api key
			...
			"wxpayPublicKeyId": "PUB_KEY_ID_0117380333822026011200292334001000", // v3需要用到的微信支付公钥ID，值为以PUB_KEY_ID_开头的一串字符串（仅限开启了微信支付公钥的商户，若已开通微信支付平台证书的商户可无视此参数或注释掉此参数）
