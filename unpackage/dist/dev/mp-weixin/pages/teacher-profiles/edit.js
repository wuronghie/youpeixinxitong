...
const _sfc_main = {
  ...
  methods: {
    ...
    getDetail(id) {
      ...
      db.collection(dbCollectionName).doc(id).field("teacher_id,display_name,avatar,subjects,grades,hourly_rate,rating,review_count,introduction,teaching_areas,is_verified,available,total_courses,total_students").get().then((res) => {
    ...
    submit() {
      if (!this.validateForm())
        return;
      const db = common_vendor.tr.database();
      db.collection(dbCollectionName).doc(this.formDataId).update(this.formData).then((res) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d3e4958f"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/teacher-profiles/edit.js.map
