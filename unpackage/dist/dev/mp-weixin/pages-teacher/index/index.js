...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: $data.profileComplete && !$data.profileComplete.isComplete && $data.profileComplete.missingFieldsText && $data.profileComplete.missingFieldsText.length > 0
  }, $data.profileComplete && !$data.profileComplete.isComplete && $data.profileComplete.missingFieldsText && $data.profileComplete.missingFieldsText.length > 0 ? {
    b: common_vendor.f($data.profileComplete.missingFieldsText, (field, index, i0) => {
      return {
        a: common_vendor.t(field),
        b: index
      };
    }),
    c: common_vendor.o((...args) => $options.goToEditProfile && $options.goToEditProfile(...args))
  } : {}, {
